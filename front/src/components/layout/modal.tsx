...
export function Modal({ onClose, onConfirm, title }: Props) {
    ...
    return (
      <div
        ...
        onClick={onClose}
      >
        <div className="bg-white p-8 rounded shadow-lg text-center" onClick={e => e.stopPropagation()}>
          <div className="mb-4">{title}</div>
          <div className="flex gap-8 justify-center">
            <button className="bg-blue-600 text-white px-5 py-2 rounded" onClick={onConfirm}>
              はい
            </button>
